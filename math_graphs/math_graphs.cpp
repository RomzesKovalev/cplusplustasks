...
int main() {
    ...
    while (window.isOpen()) {
        ...
        while (window.pollEvent(event)) {
            ...
            if (event.type == sf::Event::MouseButtonPressed) {
                if (event.mouseButton.button == sf::Mouse::Left) {
                    ...
                    if ((mathY == abs(mathX) - 5) || (mathX == 0)) {
                        zone = "you`re a caught in the intersection of two functions!";
                    }
                    else if ((mathX > 0) && (mathY > abs(mathX) - 5)) {
                        zone = "1";
                    }
                    else if ((mathX < 0) && (mathY < abs(mathX) - 5)) {
                        zone = "2";
                    }
                    else if ((mathY > abs(mathX) - 5) && (mathX < 0)) {
                        zone = "3";
                    }
                    else if ((mathY < abs(mathX) - 5) && (mathX > 0)) {
                        zone = "4";
        ...
        drawGraphY(window, [](float x) {return abs(x) - 5; }, -10, 10, 30, 30, sf::Color::Red);
        drawGraphX(window, [](float y) {return 0; }, -10, 10, 30, 30, sf::Color::Blue);
